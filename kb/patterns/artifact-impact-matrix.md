...
|---------------------------|-------------------------------------------------------------------------------------|-------------------------------------------------------------------|------------------|
| `1-cynefin-framing.md`    | `2-event-storm.md`, `plan.md`                                                      | Hotspots re-map; core-domain classification shifts                 | HIGH             |
| `2-event-storm.md`        | `3-domain-stories.md`, `4-glossary.md`, `5-bc-candidates.md`, `7-adr/*`, `0-diagrams/*` (T1.4, T2.2, T2.3, T3.1) | Events ground narratives; surface terms; pivotal events suggest BC boundaries; ADRs may cite schema; event ribbon + actor matrix + external landscape + golden-path sequences re-derive | HIGH             |
...
| `4-glossary.md`           | `5-bc-candidates.md`, `6-contexts/*.md`, `7-context-map.md`, `7-adr/*`, `0-diagrams/*` (T1.3, T1.5, T3.3) | Renaming Manifest cascade; UL consistency enforced across all downstream artifacts; aggregate model + state machines + visibility matrix carry glossary terms verbatim | CRITICAL         |
| `5-bc-candidates.md`      | `6-contexts/*.md`, `7-context-map.md`, `7-adr/*`, `0-diagrams/*` (T1.1, T2.1)      | BC boundaries determine canvas set + context-map edges + ADR references; capability map + strategic-classification heatmap re-derive | HIGH             |
| `6-contexts/<bc>.md`      | `7-context-map.md`, `7-adr/*`, `4-glossary.md`, `0-diagrams/*` (T1.1, T1.3, T2.2)  | Inbound/outbound ↔ map edges; UL drift in § 7 triggers glossary sweep; capability map + aggregate model + actor-context matrix carry canvas labels | HIGH             |
| `7-context-map.md`        | `7-adr/*`, `6-contexts/*.md`, `0-diagrams/*` (T1.2, T4.1)                          | Edge redefinition → ADR revisit; canvas communication roles shift; context-map diagram + coupling matrix re-derive | HIGH             |
| `7-adr/<adr>.md`          | `5-bc-candidates.md`, `7-context-map.md`, `4-glossary.md`, `0-diagrams/*` (T3.2, T4.2) | Accepted/superseded decisions may change BC set, map, or terms; fallback decision tree + ADR dependency graph re-derive | MEDIUM           |
